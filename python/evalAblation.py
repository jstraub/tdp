...
outputPath = "../results/"+tag+"/simpleMapGradNormTrack/"
SetMode(samplePoints=False, dirObsSelect=False, gradNormObsSelect=True);
Run(datsetPath, configString, outputPath, pathToGt);

outputPath = "../results/"+tag+"/simpleMapDirSegTrack/"
SetMode(samplePoints=False, dirObsSelect=True, gradNormObsSelect=False);
Run(datsetPath, configString, outputPath, pathToGt);
